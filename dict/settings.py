...
ALLOWED_HOSTS = ['mofrey.up.railway.app','127.0.0.1']
CSRF_TRUSTED_ORIGINS=['https://mofrey.up.railway.app','https://127.0.0.1']
...
DATABASE_URL = os.getenv('MOFREY_DB_URL')
